...
class InputGroup {
    ...
    static get style() { return ":host{-webkit-box-sizing:border-box;box-sizing:border-box}*,:after,:before{-webkit-box-sizing:inherit;box-sizing:inherit}label{display:block;margin-bottom:6px;cursor:text;color:#666;font-size:14px}"; }
}
