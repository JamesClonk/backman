...
class Body {
    ...
    static get style() { return ".sc-sdx-accordion-item-body-h{-webkit-box-sizing:border-box;box-sizing:border-box}*.sc-sdx-accordion-item-body, .sc-sdx-accordion-item-body:after, .sc-sdx-accordion-item-body:before{-webkit-box-sizing:inherit;box-sizing:inherit}.sc-sdx-accordion-item-body-h{position:relative;overflow:hidden;display:none;height:0;opacity:0;padding:0 13px 14px 19px}.open.sc-sdx-accordion-item-body-h{display:block;height:auto;opacity:1}[arrow-position=center].sc-sdx-accordion-item-body-h{padding-left:15px;padding-right:15px}[arrow-position=center].open.sc-sdx-accordion-item-body-h{padding-bottom:16px}"; }
}
