...
RUN apt-get -y $package_args update && \
  apt-get -y $package_args install mysql-client postgresql-client-12 mongodb-org-tools=4.4.8 mongodb-org-shell=4.4.8 redis-tools nodejs openssh-server bash vim && \
  apt-get clean && \
