...
RUN apt-get -y $package_args update && \
  apt-get -y $package_args install mysql-client postgresql-client-11 mongodb-org-tools=4.2.0 mongodb-org-shell=4.2.0 redis-tools nodejs openssh-server bash vim && \
  apt-get clean && \
